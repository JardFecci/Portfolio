...
ALTER TABLE ALBUM
ADD CONSTRAINT Album_ArtistID_fk Foreign Key (ArtistID) REFERENCES ARTEEST(ArtistID)

ALTER TABLE ARTEEST
ADD CONSTRAINT ARTEEST_Cat_ID_fk Foreign Key (Cat_ID) REFERENCES CATEGORY(Cat_ID)